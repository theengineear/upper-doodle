...
export class Coordinates {
     ...
     */
    static clientToView(svgElement: SVGSVGElement, clientX: number, clientY: number): {
        viewX: number;
        viewY: number;
    };
    /**
     ...
     */
    static viewToWorld(viewX: number, viewY: number, scene: {
        x: number;
        y: number;
        k: number;
    }, kx?: number, ky?: number): {
     ...
     * @returns {{viewX: number, viewY: number}} View coordinates
     */
    static worldToView(x: number, y: number, scene: {
        x: number;
        y: number;
        k: number;
    }, kx?: number, ky?: number): {
