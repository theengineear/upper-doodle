...
describe('UpperDoodle.valueFromJSON', () => {
  it('Rectangle element properties are in canonical order', () => {
    ...
    const actual = UpperDoodle.valueFromJSON(unordered);
  ...
  it('Identical objects produce identical JSON strings', () => {
    ...
    const canonical1 = UpperDoodle.valueFromJSON(doc1);
    const canonical2 = UpperDoodle.valueFromJSON(doc2);
